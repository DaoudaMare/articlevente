            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="indexAdmin.php" class="nav-item nav-link active">Accueil</a>
                        <a href="voitureForms.php" class="nav-item nav-link ">Publier Voitures</a>
                        
                        <div class="nav-item dropdown">
                            <a href="accessoire.php" class="nav-link dropdown-toggle" data-toggle="dropdown">Accessoires</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                ...
                                <a href="vetementForms.php" class="dropdown-item">vetements</a>
                            </div>
                        </div>
